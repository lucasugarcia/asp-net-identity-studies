...
namespace ByteBank.Forum.Controllers
{
    public class ContaController : Controller
    {
        ...
        private UserManager<UsuarioAplicacao> UserManager
        {
            get
            {
        ...
        private async Task EnviarEmailDeConfirmacao(UsuarioAplicacao usuario)
        {
            ...
            await UserManager.SendEmailAsync(usuario.Id, $"Confirmação de E-mail", $"Bem vindo ao fórum ByteBank, clique aqui {linkDeCallback} para confirmar seu email!");
        }
